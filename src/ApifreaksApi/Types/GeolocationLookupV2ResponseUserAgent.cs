...
/// </summary>
[Serializable]
public record GeolocationLookupV2ResponseUserAgent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public GeolocationLookupV2ResponseUserAgentDevice? Device { get; set; }

    /// <summary>
    /// Rendering engine details.
    /// </summary>
    [JsonPropertyName("engine")]
    public GeolocationLookupV2ResponseUserAgentEngine? Engine { get; set; }

    /// <summary>
    /// Operating system details.
    /// </summary>
    [JsonPropertyName("operating_system")]
    public GeolocationLookupV2ResponseUserAgentOperatingSystem? OperatingSystem { get; set; }

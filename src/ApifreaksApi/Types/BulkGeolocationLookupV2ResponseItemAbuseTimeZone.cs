...
/// </summary>
[Serializable]
public record BulkGeolocationLookupV2ResponseItemAbuseTimeZone : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstStart? DstStart { get; set; }

    /// <summary>
    /// DST transition details (used for both the DST start and DST end transitions).
    /// </summary>
    [JsonPropertyName("dst_end")]
    public BulkGeolocationLookupV2ResponseItemAbuseTimeZoneDstEnd? DstEnd { get; set; }

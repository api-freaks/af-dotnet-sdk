...
/// </summary>
[Serializable]
public record DomainWhoisLookupV2ResponseRegistryData : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DomainWhoisLookupV2ResponseRegistryDataDomainRegistered? DomainRegistered { get; set; }
    ...
    public DomainWhoisLookupV2ResponseRegistryDataDomainRegistrar? DomainRegistrar { get; set; }

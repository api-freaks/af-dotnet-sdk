...
/// </summary>
[Serializable]
public record BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContact : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistered DomainRegistered { get; set; }
    ...
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactDomainRegistrar? DomainRegistrar { get; set; }
    ...
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactResellerContact? ResellerContact { get; set; }

    /// <summary>
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    /// </summary>
    [JsonPropertyName("registrant_contact")]
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistrantContact? RegistrantContact { get; set; }

    /// <summary>
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    /// </summary>
    [JsonPropertyName("administrative_contact")]
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAdministrativeContact? AdministrativeContact { get; set; }

    /// <summary>
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    /// </summary>
    [JsonPropertyName("technical_contact")]
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactTechnicalContact? TechnicalContact { get; set; }

    /// <summary>
    /// A contact record (registrant, administrative, technical, billing, or reseller) published in the domain's WHOIS record.
    /// </summary>
    [JsonPropertyName("billing_contact")]
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactBillingContact? BillingContact { get; set; }

    /// <summary>
    /// Registrar's abuse-reporting contact.
    /// </summary>
    [JsonPropertyName("abuse_contact")]
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactAbuseContact? AbuseContact { get; set; }
    ...
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactEligibilityInfo? EligibilityInfo { get; set; }
    ...
    public BulkDomainWhoisLookupV2ResponseBulkWhoisResponseItemAbuseContactRegistryData? RegistryData { get; set; }

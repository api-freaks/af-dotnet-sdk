...
[Serializable]
public record DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryData : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataDomainRegistered? DomainRegistered { get; set; }
    ...
    public DomainWhoisHistoryResponseWhoisDomainsHistoricalItemRegistryDataDomainRegistrar? DomainRegistrar { get; set; }

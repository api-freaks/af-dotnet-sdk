...
[Serializable]
public record DomainWhoisLookupResponseRegistryData : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DomainWhoisLookupResponseRegistryDataDomainRegistered? DomainRegistered { get; set; }
    ...
    public DomainWhoisLookupResponseRegistryDataDomainRegistrar? DomainRegistrar { get; set; }

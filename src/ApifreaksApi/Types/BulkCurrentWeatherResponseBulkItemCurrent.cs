...
/// </summary>
[Serializable]
public record BulkCurrentWeatherResponseBulkItemCurrent : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required BulkCurrentWeatherResponseBulkItemCurrentAstronomy Astronomy { get; set; }

    /// <summary>
    /// Air quality metrics including pollutant concentrations and AQI values.
    /// </summary>
    [JsonPropertyName("air_quality")]
    public required BulkCurrentWeatherResponseBulkItemCurrentAirQuality AirQuality { get; set; }

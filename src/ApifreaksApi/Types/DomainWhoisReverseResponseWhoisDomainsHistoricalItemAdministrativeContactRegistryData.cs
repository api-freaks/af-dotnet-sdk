...
[Serializable]
public record DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryData
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistered? DomainRegistered { get; set; }
    ...
    public DomainWhoisReverseResponseWhoisDomainsHistoricalItemAdministrativeContactRegistryDataDomainRegistrar? DomainRegistrar { get; set; }
